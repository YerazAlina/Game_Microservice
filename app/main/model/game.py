...
class Game(db.Model):
    ...
    #als ik game_name gebruik neemt ie dat over in de database en krijg ik een error (zelfde voor gameName)
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    gamename = db.Column(db.String(50), nullable=False)
    gamedescription = db.Column(db.String(100), nullable=False)
